...
const ChangePasswordModal = ({toggleModal}) => {
    ...
    const handleSubmit = async () => { 
        ...
        if (!formData.confirmNewPassword) { 
            ...
            newErrors.confirmNewPassword = 'Must be atleast 8 characters.'; 
        ...
        if(Object.keys(newErrors).length === 0){
            ...
            try {
                ...
                const response = await fetch('http://192.168.1.25/api/updateUserPassword', {
                  method: 'PUT',
                  headers: {
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={{ width: '100%', height: '100%', backgroundColor: 'rgba(0, 0, 0, 0.7)', zIndex: 3, alignItems: 'center', position: 'absolute', }}>
            <View style={{ backgroundColor: '#161616', display: 'flex', alignItems: 'center', zIndex: 5, marginTop: '50%', color: 'white', borderRadius: 20, width: screenWidth-20, }}>
                ...
                <Pressable style={{backgroundColor: '#323232', position: 'absolute', width: 20, top: 4, right: 10, textAlign: 'center', margin: 2, marginTop: 8, marginBottom: 6, borderRadius: 6}} onPress={toggleModal}>
